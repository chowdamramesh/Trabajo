...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<gcm.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, gcm.backend.registration.model.CollectionResponseRegistrationRecord.class);
  ...
  /**
   * Create a request for the method "newUserDetials".
   *
   * This request holds the parameters needed by the registration server.  After setting any optional
   * parameters, call the {@link NewUserDetials#execute()} method to invoke the remote operation.
   *
   * @param content the {@link gcm.backend.registration.model.UserDetialsGcm}
   * @return the request
   */
  public NewUserDetials newUserDetials(gcm.backend.registration.model.UserDetialsGcm content) throws java.io.IOException {
    NewUserDetials result = new NewUserDetials(content);
    initialize(result);
    return result;
  }

  public class NewUserDetials extends RegistrationRequest<gcm.backend.registration.model.UserDetialsGcm> {

    private static final String REST_PATH = "userdetials_gcm";

    /**
     * Create a request for the method "newUserDetials".
     *
     * This request holds the parameters needed by the the registration server.  After setting any
     * optional parameters, call the {@link NewUserDetials#execute()} method to invoke the remote
     * operation. <p> {@link NewUserDetials#initialize(com.google.api.client.googleapis.services.Abstr
     ...
     * @since 1.13
     */
    protected NewUserDetials(gcm.backend.registration.model.UserDetialsGcm content) {
      super(Registration.this, "POST", REST_PATH, content, gcm.backend.registration.model.UserDetialsGcm.class);
    }

    @Override
    public NewUserDetials setAlt(java.lang.String alt) {
      return (NewUserDetials) super.setAlt(alt);
    }

    @Override
    public NewUserDetials setFields(java.lang.String fields) {
      return (NewUserDetials) super.setFields(fields);
    }

    @Override
    public NewUserDetials setKey(java.lang.String key) {
      return (NewUserDetials) super.setKey(key);
    }

    @Override
    public NewUserDetials setOauthToken(java.lang.String oauthToken) {
      return (NewUserDetials) super.setOauthToken(oauthToken);
    }

    @Override
    public NewUserDetials setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (NewUserDetials) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public NewUserDetials setQuotaUser(java.lang.String quotaUser) {
      return (NewUserDetials) super.setQuotaUser(quotaUser);
    }

    @Override
    public NewUserDetials setUserIp(java.lang.String userIp) {
      return (NewUserDetials) super.setUserIp(userIp);
    }

    @Override
    public NewUserDetials set(String parameterName, Object value) {
      return (NewUserDetials) super.set(parameterName, value);
    }
  }
