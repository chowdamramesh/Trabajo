 ...
 * on 2016-10-28 at 06:02:46 UTC 
 * Modify at your own risk.
 */

package gcm.backend.messaging;
...
public class Messaging extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class MessagingEndpoint {
    ...
    /**
     * Create a request for the method "messagingEndpoint.sendMessageAccToUsrname".
     *
     * This request holds the parameters needed by the messaging server.  After setting any optional
     * parameters, call the {@link SendMessageAccToUsrname#execute()} method to invoke the remote
     * operation.
     *
     * @param message
     * @param usrname
     * @return the request
     */
    public SendMessageAccToUsrname sendMessageAccToUsrname(java.lang.String message, java.lang.String usrname) throws java.io.IOException {
      SendMessageAccToUsrname result = new SendMessageAccToUsrname(message, usrname);
      initialize(result);
      return result;
    }

    public class SendMessageAccToUsrname extends MessagingRequest<Void> {

      private static final String REST_PATH = "sendMessageAccToUsrname/{message}/{usrname}";

      /**
       * Create a request for the method "messagingEndpoint.sendMessageAccToUsrname".
       *
       * This request holds the parameters needed by the the messaging server.  After setting any
       * optional parameters, call the {@link SendMessageAccToUsrname#execute()} method to invoke the
       * remote operation. <p> {@link SendMessageAccToUsrname#initialize(com.google.api.client.googleapi
       ...
       * @since 1.13
       */
      protected SendMessageAccToUsrname(java.lang.String message, java.lang.String usrname) {
        super(Messaging.this, "POST", REST_PATH, null, Void.class);
        this.message = com.google.api.client.util.Preconditions.checkNotNull(message, "Required parameter message must be specified.");
        this.usrname = com.google.api.client.util.Preconditions.checkNotNull(usrname, "Required parameter usrname must be specified.");
      }

      @Override
      public SendMessageAccToUsrname setAlt(java.lang.String alt) {
        return (SendMessageAccToUsrname) super.setAlt(alt);
      }

      @Override
      public SendMessageAccToUsrname setFields(java.lang.String fields) {
        return (SendMessageAccToUsrname) super.setFields(fields);
      }

      @Override
      public SendMessageAccToUsrname setKey(java.lang.String key) {
        return (SendMessageAccToUsrname) super.setKey(key);
      }

      @Override
      public SendMessageAccToUsrname setOauthToken(java.lang.String oauthToken) {
        return (SendMessageAccToUsrname) super.setOauthToken(oauthToken);
      }

      @Override
      public SendMessageAccToUsrname setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (SendMessageAccToUsrname) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public SendMessageAccToUsrname setQuotaUser(java.lang.String quotaUser) {
        return (SendMessageAccToUsrname) super.setQuotaUser(quotaUser);
      }

      @Override
      public SendMessageAccToUsrname setUserIp(java.lang.String userIp) {
        return (SendMessageAccToUsrname) super.setUserIp(userIp);
      }
      ...
      public SendMessageAccToUsrname setMessage(java.lang.String message) {
        this.message = message;
        return this;
      }
      ...
      public SendMessageAccToUsrname setUsrname(java.lang.String usrname) {
        this.usrname = usrname;
        return this;
      }

      @Override
      public SendMessageAccToUsrname set(String parameterName, Object value) {
        return (SendMessageAccToUsrname) super.set(parameterName, value);
      }
    }
