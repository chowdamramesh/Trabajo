 ...
 */
public class ProTaskRetrieve extends AsyncTask<String,Void,List<TaskDetails>> {
...
//                    .setRootUrl("http://10.0.2.2:8080/_ah/api")
        ...
        List<TaskDetails> allGot = new ArrayList<>();

        try {
            allGot = myApiService.proTaskRetrieve(got).execute().getItems();
        } catch (IOException e) {
            e.printStackTrace();
        }
        return allGot;
